...
<head>
  ...
  <title> STI Registrar | Permit Manager </title>
  <!-- plugins:css -->
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                    ...
                    if (isset($_POST['search'])) {
                      ...
                      $query = "SELECT * FROM tbl_permits WHERE CONCAT(student_id) LIKE '%".$find_value."%' ORDER BY student_id DESC";
                      $searchResult = filterTable($query);

                    } else {

                      $query = "SELECT * FROM tbl_permits ORDER BY student_id DESC";
                      $searchResult = filterTable($query);
                    ...
                    ?>
                    <form action="permitManager.php" method="POST">
                      <div class="row">
                        <div class="col-lg-12 d-flex flex-column">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <h4 class="card-title">Manage Permits</h4>
                                </div>
                                <div class="col-md-5">
                                  <div class="row">
                                    <div class="col-sm-2">
                                ...
                                <div class="col-md-3">
                                  <a href="permitManager_edit.php"><button type="button" class="btn btn-icon-text btn-secondary" style="float: right;"> Edit Subject Proctors </button></a>
                                </div>
                              </div>
                                
                              <p class="card-description">
                                Viewing all of data inside the database of Permits. You are able to Edit and Delete or basically modify premits within the Database of Permits.
                              </p>
                                  ...
                                  <tbody>
                                    ...
                                    <?php 
                                      ...
                                      <tr>
                                        ...
                                        <?php } ?>
                                        <td></td>
                                        <td><?php echo $row['pt_prelim']; ?></td>
                                        <td><?php echo $row['pt_midterm']; ?></td>
                                        <td><?php echo $row['pt_prefinal']; ?></td>
                                        <td><?php echo $row['pt_final']; ?></td>
                                        <td></td>
