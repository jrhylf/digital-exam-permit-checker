...
<head>
  ...
  <title> STI Registrar | Set School Year </title>
  <!-- plugins:css -->
                      ...
                      <div class="col-lg-12 d-flex flex-column">
                        <div class="row">
                          <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="card-title"> Modify School Year </h4>
                                <?php include('successPrompt.php');?>
                                <form class="forms-sample" action="calendarSchoolYear.php" method="POST" autocomplete="off">
                                  <div class="form-group">
                                    <label for="From">From</label>
                                    <input type="text" class="form-control form-control-lg" id="From" placeholder="From" name="From" required onkeyup="incrementYear(this.value)">
                                  </div>
                                  <div class="form-group">
                                    <label for="From">To</label>
                                    <input type="number" class="form-control form-control-lg" id="To" placeholder="To" name="To" required readonly>
                                  </div>
                                  <button type="submit" class="btn btn-primary me-2" style="color: white; padding: 15px; width: 100%;" name="setSY">Set School Year</button>

                                  <script type="text/javascript">
                                    function incrementYear(value){
                                      var from = parseInt(value)+1;
                          ...
                          <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="card-title"> STI School Year </h4>
                                <br>
                                <div class="row">
                                  <div class="col">
                                    <img src="images/school.png" style="height: 120px; margin-left: 30px;" />
                                  </div>
                                ...
                                <br>
                                <p class="card-description"> At STI, the opportunities for career growth are many and wide-ranging. If you’re talented, proactive, and excited about having a fulfilling career in a global company with ambitious and attainable goals, we look forward to hearing from you. </p>
                              </div>
                            </div>
                          </div>
                        </div>
