...
<head>
  ...
  <title> STI Registrar | Proctor Maintenance </title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                        ...
                        <div class="col-12 grid-margin stretch-card">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <input type="file" name="import_Proctors_file" class="form-control">
                                </div>
                                <div class="col-md-6">
                                  <button type="submit" name="btn_import_Proctors" class="btn btn-success btn-icon-text" style="color: white; width: 50%; float: left; margin-left: 0;">
                    ...
                    if (isset($_POST['search'])) {
                      ...
                      $query = "SELECT * FROM tbl_proctors WHERE CONCAT(first_name, middle_name, last_name, initials) LIKE '%".$find_value."%' ORDER BY proctor_id DESC";
                      $searchResult = filterTable($query);

                    } else {

                      $query = "SELECT * FROM tbl_proctors ORDER BY proctor_id DESC";
                      $searchResult = filterTable($query);
                    ...
                    <form action="maintenanceProctor.php" method="POST">
                      <div class="row">
                        <div class="col-lg-12 d-flex flex-column">
                          <div class="card">
                            <div class="card-body">
                              <div class="row">
                                <div class="col-md-3">
                                  <h4 class="card-title">Manage Proctors</h4>
                                </div>
                                <div class="col-md-4">
                                  <div class="row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-md" placeholder="Search Proctor" aria-label="Search" style="float: right; margin-top: 2px;" name="find_value">
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-5">
                                  <button type="button" class="btn btn-danger btn-icon" style="float: right; color: white;" onclick="deleteAllProctors('sti_registrar')">
                                    <i class="mdi mdi-delete"></i>
                                    All
                                  </button>
                                  <a href="maintenanceProctor_add.php"><button type="button" class="btn btn-icon-text btn-secondary" style="float: right;"><i class="btn-icon-prepend mdi mdi-plus"></i> Add Proctor </button></a>
                                </div>
                              </div>
                              <p class="card-description">
                                Viewing all of data inside the database of Proctors. You are able to Edit and Delete or basically modify proctors within the Database of Proctors.
                              </p>
                              <div class="table-responsive" style="display: block; max-height: 500px; overflow-y: scroll;">
                                <table class="table table-striped">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <a href="maintenanceProctor_edit.php?editProctor=<?php echo $row['proctor_id']; ?>"><button type="button" class="btn btn-primary" style="color: white;">Edit</button></a>
                                        <button type="button" class="btn btn-danger" onclick="deleteProc('<?php echo $row['proctor_id']; ?>', '<?php echo $row['first_name']; ?>', '<?php echo $row['last_name']; ?>')" style="color: white;">Delete</button></td>
                                    </tr>
                                    <?php } ?>
                                  </tbody>
                                </table>
        ...
        <script type="text/javascript">
          function deleteAllProctors(pass){
            var password = prompt("Please enter your password to confirm deletion:");

            if (password == pass) {
              if (confirm("Are you sure you want to delete all records from Proctors at once? Please confirm if you approve of this decision.")) {
                window.location.href='deleteProcess.php?delAllProctors=true';
              }
            } else {
        ...
        <script type="text/javascript">
          function deleteProc(delID, firstName, lastName){
            let name = firstName + " " + lastName
              if (confirm("Are you sure you want to delete proctor - " + name + "? This will not delete the proctor from the permits if the proctor has signed the permit for the quarter.")) {
                  window.location.href='deleteProcess.php?delProctor='+ delID;
              }
          }
        </script>
