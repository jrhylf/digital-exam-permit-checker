...
<head>
  ...
  <title> STI Registrar | Add Proctor </title>
  <!-- plugins:css -->
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">Add Proctor</h4>
                          <?php include('successPrompt.php'); ?>
                          <?php include('errorPrompt.php'); ?>
                          <form action="maintenanceProctor_add.php" method="POST">
                            <div class="form-group row">
                              ...
                              <div class="col">
                                <p>Middle Name:</p>
                                <input class="form-control" type="text" name="middleName" placeholder="Middle Name" value="">
                              </div>
                            </div>

                            <div class="form-group row">
                              <div class="col">
                                <button class="btn btn-primary btn-lg" name="addProctor" style="color: white; width: 100%; margin-bottom: 0;"> Add Proctor </button>
                              </div>
                            </div>
                          </form>
                        </div>
