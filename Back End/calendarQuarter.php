...
<head>
  ...
  <title> STI Registrar | Set Quarter </title>
  <!-- plugins:css -->
                      ...
                      <div class="col-lg-12 d-flex flex-column">
                        <div class="row">
                          <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="card-title"> Modify Quarter </h4>
                                <?php include('successPrompt.php');?>
                                <form class="forms-sample" action="calendarQuarter.php" method="POST" autocomplete="off">
                                  ...
                                  <button type="submit" class="btn btn-primary me-2" style="color: white; padding: 15px; width: 100%;" name="setQuarter">Set Semester</button>
                                </form>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="card-title"> STI Quarter </h4>
                                <div class="row" style="margin-top: 33px;">
                                  <div class="col">
                                    <img src="images/stationery.png" style="height: 120px; margin-left: 40px;" />
                                  </div>
                                  <div class="col" style="margin-top: 25px; margin-left: -80px;">
