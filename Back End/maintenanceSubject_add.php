...
<head>
  ...
  <title> STI Registrar | Add Subject </title>
  <!-- plugins:css -->
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <form action="maintenanceSubject_add.php" method="POST">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col">
                                <p>Subject Code:</p>
                                <input class="form-control form-control-lg" type="text" name="subjectCode" placeholder="Subject Code" value="" required="">
                              </div>
                              <div class="col">
                                <p>Subject Description:</p>
                                <input class="form-control form-control-lg" type="text" name="subjectDescription" placeholder="Subject Description" value="" required="">
                              </div>
                            </div>

                            <div class="form-group row">
                              <div class="col">
                                <button class="btn btn-primary btn-lg" name="addSubject" style="color: white; width: 100%; margin-bottom: 0;"> Add Subject </button>
                              </div>
                            </div>
                          </form>
                        </div>
        ...
        <script type="text/javascript">
          $(document).ready(function(){
            $('#course').on('change', function(){
                var courseValuesSub = this.value;
                if(courseValuesSub){
                    $.ajax({
                        type:'POST',
                        url:'getDropdownValues.php',
                        data:'courseValuesSub='+courseValuesSub,
