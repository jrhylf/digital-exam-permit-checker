...
<head>
  ...
  <title> STI Registrar | Registrar Maintenance </title>
  <!-- plugins:css -->
                          ...
                          <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                ...
                                In this module, you would be able to add registrars inside the database of registrars and view them at the tables beside.
                                </p>
                                
                                <form class="forms-sample" action="maintenanceRegistrar.php" method="POST" autocomplete="off">
                                  <div class="form-group">
                                    <label for="exampleInputUsername1">Registrar Name</label>
                                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Administrator Name" name="registrarName" required >
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Username</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Username" name="registrarUName" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Password</label>
                                    <input type="password" class="form-control" id="password" placeholder="Password" name="registrarPass" required>
                                  </div>
                                  ...
                                  <div class="row" style="margin-left: 20px;">
                                    <button type="submit" class="btn btn-primary me-2" style="color: white; padding: 15px; width: 90%;" name="addRegistrar" onclick="addRegis()">Add Registrar</button>
                                  </div>
                                </form>
                              </div>
                            </div>
                          ...
                          <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                ...
                                <p class="card-description">
                                Viewing all of data inside the database of Registrars. You are able to Edit and Delete or basically modify admins within the Database of Registrars.
                                </p>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <button type="button" class="btn btn-danger" onclick="deleteRegistrar(<?php echo $row['registrar_id']; ?>)" style="color: white;"> Delete </button>
                                        </td>
                                      </tr>

                                      <script type="text/javascript">
                                        function deleteRegistrar(delID){
                                            if (confirm("Are you sure you want to delete <?php echo $row['registrar_name'];?> from registrar accounts?")) {
