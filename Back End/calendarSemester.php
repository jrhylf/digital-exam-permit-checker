...
<head>
  ...
  <title> STI Registrar | Set Semester </title>
  <!-- plugins:css -->
                      ...
                      <div class="col-lg-12 d-flex flex-column">
                        <div class="row">
                          <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="card-title"> Modify Semester </h4>
                                <?php include('successPrompt.php');?>
                                <form class="forms-sample" action="calendarSemester.php" method="POST" autocomplete="off">
                                  <div class="form-group">
                                    <label>Select Semester</label>
                                    <select class="js-example-basic-single w-100 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" style="padding: 10px;" name="sem">
                                      <?php $semesterResult = mysqli_query($db, "SELECT semester FROM tbl_qs");?>
                                      <?php while($semrow = mysqli_fetch_array($semesterResult)) { ?>
                                        <option value="1" <?php if($semrow['semester'] == 1) echo 'selected="selected"'?>>1st Semester</option>
                                        <option value="2" <?php if($semrow['semester'] == 2) echo 'selected="selected"'?>>2nd Semester</option>
                                      <?php } ?>
                                    </select>
                                  </div>
                                  <button type="submit" class="btn btn-primary me-2" style="color: white; padding: 15px; width: 100%;" name="setSem">Set Semester</button>
                                </form>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="card-title"> STI Semester </h4>
                                <div class="row" style="margin-top: 33px;">
                                  <div class="col">
                                    <img src="images/binder.png" style="height: 120px; margin-left: 40px;" />
                                  </div>
