...
<head>
  ...
  <title> STI Registrar | Add Section </title>
  <!-- plugins:css -->
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <form action="maintenanceSection_add.php" method="POST">
                            <div class="form-group row">
                              ...
                              <div class="col">
                                <p>Section Number:</p>
                                <input class="form-control form-control-lg" type="number" name="sectionNumber" placeholder="Section Number" value="" required="">
                              </div>
                            </div>

                            <div class="form-group row">
                              <div class="col">
                                <button class="btn btn-primary btn-lg" name="addSection" style="color: white; width: 100%; margin-bottom: 0;"> Add Section </button>
                              </div>
                            </div>
                          </form>
                        </div>
