...
<head>
  ...
  <title> STI Registrar | Edit Proctor </title>
  <!-- plugins:css -->
              ...
              <div class="home-tab">
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                    ...
                    <?php 
                      $proctor_id = $_GET['editProctor'];
                      $getProctor = mysqli_query($db, "SELECT * FROM tbl_proctors WHERE proctor_id = '$proctor_id'");
                    ?>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">Edit Proctor</h4>
                          <form action="maintenanceProctor_edit.php" method="POST">
                            <input type="hidden" value="<?php echo $proctor_id; ?>" name="id">
                            <?php while($row = mysqli_fetch_array($getProctor)) { ?>
                            <div class="form-group row">
                              <div class="col">
                                <p>Last Name:</p>
                                <input class="form-control" type="text" name="lastName" placeholder="Last Name" value="<?php echo $row['last_name']; ?>" required="">
                              </div>
                              <div class="col">
                                <p>First Name:</p>
                                <input class="form-control" type="text" name="firstName" placeholder="First Name" value="<?php echo $row['first_name']; ?>" required="">
                              </div>
                              <div class="col">
                                <p>Middle Name:</p>
                                <input class="form-control" type="text" name="middleName" placeholder="Middle Name" value="<?php echo $row['middle_name']; ?>">
                              </div>
                            </div>
                            <?php } ?>
                            <div class="form-group row">
                              <div class="col">
                                <button class="btn btn-primary btn-lg" name="editProctor" style="color: white; width: 100%; margin-bottom: 0;"> Update Proctor </button>
                              </div>
                            </div>
                          </form>
                        </div>
