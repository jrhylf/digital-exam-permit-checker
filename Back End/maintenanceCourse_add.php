...
<head>
  ...
  <title> STI Registrar | Add Course </title>
  <!-- plugins:css -->
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <form action="maintenanceCourse_add.php" method="POST">
                            <div class="form-group row">
                              <div class="col">
                                <p>Course Code:</p>
                                <input class="form-control" type="text" name="courseCode" placeholder="Course Code" value="" required="">
                              </div>
                              <div class="col">
                                <p>Course Description:</p>
                                <input class="form-control" type="text" name="courseDescription" placeholder="Course Description" value="" required="">
                              </div>
                            </div>

                            <div class="form-group row">
                              <div class="col">
                                <button class="btn btn-primary btn-lg" name="addCourse" style="color: white; width: 100%; margin-bottom: 0;"> Add Course </button>
                              </div>
                            </div>
                          </form>
                        </div>
