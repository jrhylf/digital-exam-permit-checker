...
<head>
  ...
  <title> STI Registrar | Courses Maintenance </title>
  <!-- plugins:css -->
              ...
              <div class="home-tab">
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                    ...
                    <?php $coursesResults = mysqli_query($db, "SELECT * FROM tbl_courses ORDER BY course_id DESC");?>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <a href="maintenanceCourse_add.php"><button id="triggerModal" class="btn btn-icon-text btn-secondary" style="float: right;"><i class="btn-icon-prepend mdi mdi-plus"></i> Add Courses </button></a>
                              </div>
                            </div>

                            <p class="card-description">
                              Viewing all of data inside the database of Courses. You are able to Edit and Delete or basically modify courses within the Database of Courses.
                            </p>
                            <div class="table-responsive" style="display: block; max-height: 600px; overflow-y: scroll">
                              <table class="table table-striped">
                                <thead style="top: 0; z-index: 2; position: sticky; background-color: #fff;">
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_array($coursesResults)) { ?>
                                      <tr>
                                        <td><?php echo $row['course_id']; ?></td>
                                        <td><?php echo $row['course_code']; ?></td>
                                        <td><?php echo $row['course_description']; ?></td>
                                        <td>
                                          <a href="maintenanceCourse_edit.php?editCourse=<?php echo $row['course_id']; ?>">
                                            <button href="maintenanceCourse_edit.php?editCourse=<?php echo $row['course_id']; ?>" type="button" class="btn btn-primary" style="color: white;">Edit</button>
                                          </a>
                                          <button type="button" class="btn btn-danger" onclick="deleteCourse('<?php echo $row['course_id']; ?>', '<?php echo $row['course_description']; ?>')" style="color: white;">Delete</button>
                                        </td>
                                      </tr>
                                      ...
                                      <script type="text/javascript">
                                        function deleteCourse(delID, courseDescription){
                                            if (confirm("Are you sure you want to delete course - " + courseDescription + "?")) {
                                                window.location.href='deleteProcess.php?delCourse='+ delID;
                                            }
                                        }
                                      </script>
