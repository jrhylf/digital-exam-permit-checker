...
<head>
  ...
  <title> STI Registrar | Subjects Maintenance </title>
  <!-- plugins:css -->
...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                        ...
                        <div class="col-12 grid-margin stretch-card">
                          <div class="card">
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <input type="file" name="import_Subjects_file" class="form-control">
                                </div>
                                <div class="col-md-6">
                                  <button type="submit" name="btn_import_Subject" class="btn btn-success btn-icon-text" style="color: white; width: 50%; float: left; margin-left: 0;">
                    ...
                    if (isset($_POST['search'])) {
                      ...
                      $query = "SELECT * FROM tbl_subjects WHERE CONCAT(subject_code, subject_description, section) LIKE '%".$find_value."%' ORDER BY subject_id DESC";
                      $searchResult = filterTable($query);

                    } else {

                      $query = "SELECT * FROM tbl_subjects ORDER BY subject_id DESC";
                      $searchResult = filterTable($query);
                    ...
                    <form action="maintenanceSubject.php" method="POST">
                      <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control form-control-md" placeholder="Search Subject" aria-label="Search" style="float: right; margin-top: 2px;" name="find_value">
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-5">
                                  <button type="button" class="btn btn-danger btn-icon" style="float: right; color: white;" onclick="deleteAllSubjects('sti_registrar')">
                                    <i class="mdi mdi-delete"></i>
                                    All
                                  </button>
                                  <a href="maintenanceSubject_add.php"><button type="button" class="btn btn-icon-text btn-secondary" style="float: right;"><i class="btn-icon-prepend mdi mdi-plus"></i> Add Subjects </button></a>
                                </div>
                              </div>

                              <p class="card-description">
                                Viewing all of data inside the database of Subjects. You are able to Edit and Delete or basically modify students within the Database of Subjects.
                              </p>
                                  ...
                                  <tbody>
                                    <?php while($row = mysqli_fetch_array($searchResult)) { ?>
                                      <tr>
                                        ...
                                        <td>
                                          <a href="maintenanceSubject_edit.php?editSubject=<?php echo $row['subject_id']; ?>">
                                            <button href="maintenanceSubject_edit.php?editSubject=<?php echo $row['subject_id']; ?>" type="button" class="btn btn-primary" style="color: white;">Edit</button>
                                          </a>
                                          <button type="button" class="btn btn-danger" onclick="deleteSubject('<?php echo $row['subject_id']; ?>', '<?php echo $row['subject_description']; ?>')" style="color: white;">Delete</button>
                                        </td>
                                      </tr>
                                    <?php } ?>
                                  </tbody>
                                        <script type="text/javascript">
                                          function deleteSubject(delID, subjectDescription){
                                              if (confirm("Are you sure you want to delete subject - " + subjectDescription + "?")) {
                                                  window.location.href='deleteProcess.php?delSubject='+ delID;
                                              }
                                          }
                                        </script>
        ...
        <script type="text/javascript">
          function deleteAllSubjects(pass){
            var password = prompt("Please enter your password to confirm deletion:");

            if (password == pass) {
              if (confirm("Are you sure you want to delete all records from Subjects at once? This will also delete all the subjects in permits. Please confirm if you approve of this decision.")) {
                window.location.href='deleteProcess.php?delAllSubjects=true';
              }
            } else {
