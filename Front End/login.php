...
<html lang="en">
  <head>
    ...
    />
    <title>STI Students | Login</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                <div class="brand-logo">
                  <img src="images/STILogos.png" alt="logo" />
                </div>
                <h4>Hello! Welcome to STI Students</h4>
                <h6 class="fw-light">Sign in to continue.</h6>
                <?php include('errors.php'); ?>

                <form class="pt-3" action="login.php" method="POST" autocomplete="on">
